        ...
        <input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
          <div class="container">
            <div class="col-lg-12 mb-4">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-4">
                      ...
                      <input type="text" class="form-control" placeholder="Enter Contact Info" required="">
                  </div>
                  <div class="col-lg-4">
                      <label for="" class="mb-3">Address</label>
                      <input type="text" class="form-control" placeholder="Enter Address Info" value="" required="">
                  </div>
                </div>
            </div>
            <hr>
            ...
            <div class="col-lg-12 mb-4">
                ...
                <div class="row" id=""  <?php echo isset($type) && $type == 1 ? 'style="display: none"' : '' ?>>
